...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
    ...
    public static List<Date> getContinuous(Date startDate, Date endDate){
    ...
    public static void main(String[] args) throws Exception{
        Date startDate = DateUtils.parseDate("2020-9-9", "yyyy-MM-dd");
        Date endDate = DateUtils.parseDate("2020-10-9", "yyyy-MM-dd");
        System.out.println(getContinuous(startDate, endDate));
    }
