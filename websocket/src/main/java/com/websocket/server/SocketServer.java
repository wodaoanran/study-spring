...
import com.websocket.entity.Client;
...
public class SocketServer {
    ...
    /**
     * 服务端的userName,因为用的是set，每e个客户端的usernam必须不一样，否则会被覆盖。
     * 要想完成ui界面聊天的功能，服务端也需要作为客户端来接收后台推送用户发送的信息
     */
    private final static String SYS_USERNAME = "管理员";
